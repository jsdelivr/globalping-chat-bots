	...
	describe('parse arguments', () => {
		describe('ping', () => {
			...
			it('should throw if incorrect ping flag', () => {
				...
				expect(() => buildPostMeasurements(argsToFlags(args))).toThrow(
					'Invalid option "protocol" for "ping"!\nExpected "packets, latency, target, from, limit, share".'
				);
			});
		});
